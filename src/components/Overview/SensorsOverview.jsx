...
function SensorsOverview() {
  ...
  return (
    <div className="flex w-full select-none flex-col rounded-md border bg-stone-100 px-2 pt-1 font-light text-stone-600 shadow">
        ...
        <>
          <div className="flex flex-col">
            <div className="flex flex-col items-start justify-between border-b py-1 md:flex-row md:items-center">
              <h1 className="m-0 ml-4 p-1 text-lg md:text-xl">
